function [b_diff, a_diff , win_len] = design_diffraction_filter(aperture, Fs, c, varargin)
...
%         tau_avg(tau_avg > 1.0) = 1.0;
        ...
        if strcmp(des_type,'pm')
            ...
            b_diff = firpm(win_len, freqs/(Fs/2), tau_avg).'; 
